...
from models.QualityEstimationStyle.FullDecCometModel.helpers import load_data
...
class FullDecCometModelHyperparamSearch:
    ...
    def __init__(self, smoke_test, utility='comet', seed=0):
        ...
        self.study_name = "full_dec_comet_model_study"
        ...
        self.model_type = "full_dec_comet_model"
    ...
    def objective(self, trial: optuna.trial.Trial) -> float:
        ...
        # Create the trainer
        model_manager = FullDecCometModelManager(config["model"])
        ...
        train_dataloader, val_dataloader = load_data(config, nmt_model, tokenizer, seed=self.seed,
                                                     smoke_test=self.smoke_test, utility=self.utility)
        # Start the training
