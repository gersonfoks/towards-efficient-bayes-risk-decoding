...
from models.old.hypothesis_only_models.LastHiddenAndProbEntrLstmModel.info import LastHiddenAndProbEntrLstmModelInfo
...
class LastHiddenAndProbEntrLstmModelTrainer:

    def __init__(self, config, smoke_test):
        self.config = config
        self.smoke_test = smoke_test

        self.info = LastHiddenAndProbEntrLstmModelInfo
