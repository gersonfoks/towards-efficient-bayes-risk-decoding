...
from models.old.hypothesis_only_models.FullDecHiddenLstmModel.info import FullDecHiddenLstmInfo
...
class FullDecModelTrainer:

    def __init__(self, config, smoke_test):
        self.config = config
        self.smoke_test = smoke_test

        self.info = FullDecHiddenLstmInfo
