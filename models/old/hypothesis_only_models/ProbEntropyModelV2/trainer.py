...
from models.old.hypothesis_only_models.ProbEntropyModelV2.info import ProbEntropyModelInfoV2
...
class ProbEntropyModelTrainerV2:

    def __init__(self, config, smoke_test):
        self.config = config
        self.smoke_test = smoke_test

        self.info = ProbEntropyModelInfoV2
