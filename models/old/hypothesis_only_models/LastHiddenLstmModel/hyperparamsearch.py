...
from models.old.hypothesis_only_models.LastHiddenLstmModel.info import LastHiddenStateLstmModelInfo
from utilities.dataset.loading import load_dataset_for_training


class LastHiddenStateLstmModelHyperParamSearch(HyperparamSearch):
    ...
    def __init__(self, config, smoke_test):
        ...
        self.model_info = LastHiddenStateLstmModelInfo

        self.study_name = "last_hidden_state_lstm_study"

        self.log_dir = './logs/last_hidden_state_hyperparamsearch'
    ...
    #         callbacks=[ EarlyStopping(monitor="val_loss", divergence_threshold=0.1, patience=5),
