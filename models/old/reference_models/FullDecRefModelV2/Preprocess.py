...
from models.common.preprocessing import explode_dataset, get_prob_entropy_lookup_table, add_hypothesis_ids
from utilities.wrappers.NmtWrapper import NMTWrapper


class FullDecRefModelV2Preprocess:
    '''
    ...
    def __call__(self, data):
        ...
        prob_entropy_lookup_table = get_prob_entropy_lookup_table(dataset, self.nmt_model_wrapped, location=self.table_location)
