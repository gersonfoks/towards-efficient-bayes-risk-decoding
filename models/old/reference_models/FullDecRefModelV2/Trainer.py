...
from models.old.reference_models.FullDecRefModelV2.info import FullDecRefModelV2Info
...
class FullDecRefModelV2Trainer(BaseTrainer):

    def __init__(self, config, smoke_test):
        super().__init__(config, smoke_test)
        self.model_info = FullDecRefModelV2Info
