...
from models.old.reference_models.CrossAttentionModel.info import CrossAttentionModelInfo
...
class CrossAttentionModelTrainer(BaseTrainer):

    def __init__(self, config, smoke_test=False):
        super().__init__(config, smoke_test)
        self.config = config
        self.smoke_test = smoke_test
        self.model_info = CrossAttentionModelInfo
