...
from models.old.reference_models.LastHiddenStateRefModel.info import LastHiddenStateRefModelInfo
...
class LastHiddenStateRefModelTrainer:

    def __init__(self, config, smoke_test=False):
        self.config = config
        self.smoke_test = smoke_test
        self.model_info = LastHiddenStateRefModelInfo
    ...
    def __call__(self,):
        ...
        collate_fn = self.model_info.collator(model_manager.nmt_model, model_manager.tokenizer, n_references=3)
