...
from models.old.reference_models.BasicReferenceLstmModel.info import BasicReferenceLstmModelInfo
...
class BasicReferenceLstmModelTrainer:

    def __init__(self, config, smoke_test=False):
        self.config = config
        self.smoke_test = smoke_test
        self.model_info = BasicReferenceLstmModelInfo
