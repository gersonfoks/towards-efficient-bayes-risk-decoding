...
class BasicReferenceLstmModel(pl.LightningModule):

    def __init__(self, embedding_layer, lstm_hypothesis, lstm_references, final_layers, initialize_optimizer, device="cuda", ):
        super().__init__()
