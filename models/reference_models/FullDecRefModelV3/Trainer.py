...
from models.reference_models.FullDecRefModelV2.info import FullDecRefModelV2Info
from models.reference_models.FullDecRefModelV3.info import FullDecRefModelV3Info
...
class FullDecRefModelV3Trainer(BaseTrainer):

    def __init__(self, config, smoke_test):
        super().__init__(config, smoke_test)
        self.model_info = FullDecRefModelV3Info
