...
class FullDecRefModelV4Manager(BaseManager):
    ...
    def create_model(self):
        ...
        count_vec_embedding = torch.nn.EmbeddingBag(self.tokenizer.vocab_size, 256, mode="mean",  padding_idx=self.tokenizer.pad_token_id)
        ...
        self.model = FullDecRefModelV4(embedding_layer, lstm_layers, prob_entropy_lstm_layer,count_vec_embedding,
                                        final_layers, utility,
