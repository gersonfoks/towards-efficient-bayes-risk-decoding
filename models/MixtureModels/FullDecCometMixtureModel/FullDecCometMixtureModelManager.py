...
from models.MixtureModels.FullDecCometMixtureModel.FullDecCometMixtureModel import FullDecCometMixtureModel
...
class FullDecCometMixtureModelManager(BaseManager):
    ...
    def create_model(self):
        ...
        self.model = FullDecCometMixtureModel(embedding_layer, full_dec_pooling_layers,
