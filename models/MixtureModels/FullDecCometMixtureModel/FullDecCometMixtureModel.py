...
class FullDecCometMixtureModel(pl.LightningModule):

    def __init__(self, full_dec_embedding, full_dec_pooling_layers,
                 token_statistics_pooling_layer, comet_wrapper, final_layers, initialize_optimizer, locs_activation_function, distribution='gaussian', device="cuda", n_components=2):
        super().__init__()
        ...
        self.name = 'full_dec_comet_mixture_model_{}_{}'.format(self.distribution, self.n_components)
