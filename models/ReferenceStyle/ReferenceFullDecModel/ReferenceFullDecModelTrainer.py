...
from models.ReferenceStyle.ReferenceFullDecModel.ReferenceFullDecModelManager import ReferenceFullDecModelManager
...
class ReferenceFullDecModelTrainer(BaseTrainer):

    def __init__(self, config, smoke_test=False):
        super().__init__(config, smoke_test)

        self.manager_class = ReferenceFullDecModelManager
