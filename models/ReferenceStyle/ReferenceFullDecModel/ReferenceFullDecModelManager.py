...
class ReferenceFullDecModelManager(BaseManager):
    ...
    def create_model(self):
        ...
        self.model = ReferenceFullDecModel(embedding_layer, token_embedding_layer, full_dec_pooling_layers,
                                           token_statistics_pooling, final_layers, gate, initialize_optimizer)
        return self.model
