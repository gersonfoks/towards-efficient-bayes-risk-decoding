...
from models.hypothesis_only_models.AvgStdProbEntropyModel.AvgStdProbEntropyModel import AvgStdProbEntropyModel
...
class AvgStdProbEntropyModelManager(ModelManager):
    ...
    def create_model(self):
        ...
        self.model = AvgStdProbEntropyModel(final_layers, initialize_optimizer)
        return self.model
