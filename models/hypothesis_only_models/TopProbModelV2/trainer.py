...
from models.hypothesis_only_models.TopProbModel.info import TopProbModelInfo
from models.hypothesis_only_models.TopProbModelV2.info import TopProbModelV2Info
...
class TopProbModelV2Trainer(BaseTrainer):
    ...
    def get_dataloaders(self):
        ...
        base_path = './predictive/tatoeba-de-en/data/lookup_tables/{}_{}_top_prob'.format(
        ...
        train_preprocess = self.model_info.preprocess(self.model_manager.nmt_model, self.model_manager.tokenizer,
                                                      table_location=train_path)
        val_preprocess = self.model_info.preprocess(self.model_manager.nmt_model, self.model_manager.tokenizer,
