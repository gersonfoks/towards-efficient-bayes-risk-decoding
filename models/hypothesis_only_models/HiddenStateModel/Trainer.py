...
class HiddenStateModelTrainer:
    ...
    def __call__(self):
        ...
        model_manager = HiddenStateModelManager(config["model"])
        ...
        collate_fn = HiddenStateModelCollator(model_manager.nmt_model, model_manager.tokenizer)
        ...
        model, manager = HiddenStateModelManager.load_model(model_path)
