...
class HiddenStateModelHyperParamSearch:

    def __init__(self, config, smoke_test):
        self.config = config
        self.smoke_test = smoke_test

        self.manager = HiddenStateModelInfo.manager
        self.preprocess = HiddenStateModelInfo.preprocess
        self.collate = HiddenStateModelInfo.collate
        self.model =HiddenStateModelInfo.model
    ...
    def objective(self, trial: optuna.trial.Trial) -> float:
        ...
        batch_size = 128
        log_dir = './logs/hidden_state_model_hyperparam_search'
