...
from models.QualityEstimationStyle.FullDecCometModel.FullDecCometModelHyperparamSearch import \
    FullDecCometModelHyperparamSearch
...
def main():
    ...
    hyperparamsearch = FullDecCometModelHyperparamSearch(args.smoke_test, args.utility, args.seed)
    hyperparamsearch()
