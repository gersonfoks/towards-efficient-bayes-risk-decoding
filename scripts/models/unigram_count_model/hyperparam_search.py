...
from models.ReferenceStyle.UnigramCountModel.UnigramCountModelHyperparamsearch import UnigramCountModelHyperparamsearch
...
def main():
    ...
    hyperparamsearch = UnigramCountModelHyperparamsearch(args.smoke_test, args.utility, args.seed)
    hyperparamsearch()
