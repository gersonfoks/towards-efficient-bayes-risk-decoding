...
def main():
    ...
    model_manager = UnigramCountModelManager(config["model"])
    ...
    train_dataloader, val_dataloader = load_data(config, nmt_model, tokenizer, seed=args.seed,
                                                 ...
                                                 n_model_references = args.n_model_references
                                                 )
    ...
    log_dir = './logs/{}/unigram_count_model_{}/'.format(args.utility, args.n_model_references)
    save_dir = './saved_models/{}/unigram_count_model_{}/'.format(args.utility, args.n_model_references)
