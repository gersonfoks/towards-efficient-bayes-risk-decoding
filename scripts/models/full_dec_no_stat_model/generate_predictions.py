...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Get the predictions of a full dec no stat model ')
    parser.add_argument('--model-path', type=str,
                        default='./saved_models/comet/full_dec_no_stat_model/best/',
    ...
    model, model_manager = FullDecNoStatModelManager.load_model(args.model_path)
