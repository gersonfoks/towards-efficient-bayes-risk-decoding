...
from models.QualityEstimationStyle.CometModel.CometModelHyperparamSearch import CometModelHyperparamSearch
...
def main():
    ...
    hyperparamsearch = CometModelHyperparamSearch(args.smoke_test, args.utility, args.seed)
    hyperparamsearch()
