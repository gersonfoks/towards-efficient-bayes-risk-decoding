...
def get_dataloader(config, model_config, smoke_test=False):
    ...
    val_lookup_table_creator = TokenStatisticsLookupTableCreator(
        wrapped_nmt_model, None, load=False,
    )

    val_table = val_lookup_table_creator(val_dataset)
...
def main():
    ...
    parser.add_argument('--model-path', type=str,
                        default='./saved_models/token_statistics_lstm_comet/best/',
                        help='config to load model from')

    parser.add_argument('--config', type=str,
                        default='./configs/token_statistics_lstm_model.yml',
                        help='config to load model from')
    ...
    model, manager = TokenStatisticsModelManager.load_model(args.model_path)
